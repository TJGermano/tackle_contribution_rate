...
df_filtered['tackle_contribution_rate'] = df_filtered['within_1_yard'] / (df_filtered['within_1_yard'] + df_filtered['totalPlays'])
...
df_filtered.to_csv('all_players_1_yard_tackle_contribution.csv', index=False)
